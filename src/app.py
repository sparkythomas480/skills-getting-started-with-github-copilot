...
activities = {
    ...
    "Soccer Team": {
        "description": "Join our competitive soccer team for league matches and tournaments",
        "schedule": "Tuesdays and Thursdays, 4:30 PM - 6:00 PM",
        "max_participants": 18,
        "participants": ["ethan@mergington.edu", "harper@mergington.edu"]
    },
    "Swimming Team": {
        "description": "Competitive swimming with training for meets and relay races",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["mason@mergington.edu"]
    },
    "Music Ensemble": {
        "description": "Play instruments and perform in school concerts and recitals",
    ...
    "Model United Nations": {
        "description": "Represent countries and develop diplomacy and research skills",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 24,
        "participants": ["logan@mergington.edu", "chloe@mergington.edu"]
    },
    "Robotics Club": {
        "description": "Design and build robots to compete in engineering challenges",
